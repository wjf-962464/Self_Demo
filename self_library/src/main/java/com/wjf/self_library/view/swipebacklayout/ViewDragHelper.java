...
package com.wjf.self_library.view.swipebacklayout;
...
public class ViewDragHelper {
     ...
     * prior motion will be taken into icon_account. If this method returns true, the caller should
     ...
     *     to true if you are calling this method from {@link View#computeScroll()} or similar
     ...
     * #shouldInterceptTouchEvent(MotionEvent)} or {@link #processTouchEvent(MotionEvent)}. If one
     * of these methods has not been called for all relevant MotionEvents to track, the information
     ...
     * #shouldInterceptTouchEvent(MotionEvent)} or {@link #processTouchEvent(MotionEvent)}. You
     * should only rely on the results of this method after all currently available touch data has
    ...
    public abstract static class Callback {
         ...
         * the ViewDragHelper will icon_enter {@link #STATE_SETTLING} and the view capture will not
         * fully end until it comes to a complete stop. If neither of these methods is invoked
         * before <code>
         * onViewReleased</code> returns, the view will stop in place and the ViewDragHelper will
         ...
         * view.
         *
         * <p>If this method returns true, a call to {@link #onViewCaptured(View, int)} will follow
