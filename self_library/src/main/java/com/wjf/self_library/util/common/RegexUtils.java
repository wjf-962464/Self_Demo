...
public final class RegexUtils {
    ...
    /**
     * Replace the first subsequent of the input sequence that matches the regex with the given
     * replacement string.
     *
     * @param input       The input.
     * @param regex       The regex.
     * @param replacement The replacement string.
     * @return the string constructed by replacing the first matching subsequent by the replacement
