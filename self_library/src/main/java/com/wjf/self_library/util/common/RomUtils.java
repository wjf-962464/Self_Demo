...
public final class RomUtils {
    ...
    private static final String[] ROM_ANDROID = {"android"};
    ...
    public static RomInfo getRomInfo() {
        ...
        if (isRightRom(brand, brand, ROM_HUAWEI)) {
        ...
        } else if (isRightRom(brand, manufacturer, ROM_ANDROID)) {
            bean.name = ROM_ANDROID[0];
        } else {
    ...
    private static boolean isRightRom(
        ...
        for (String name : names) {
            if (brand.equalsIgnoreCase(name) || manufacturer.equalsIgnoreCase(name)) {
                return true;
            }
        }
        return false;
