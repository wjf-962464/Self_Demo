...
package org.jxxy.debug.barcode.decode;
...
import org.jxxy.debug.barcode.MsgConstants;
...
final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        switch (message.what) {
            case MsgConstants.DECODE:
                decode((byte[]) message.obj, message.arg1, message.arg2);
                break;
            case MsgConstants.QUIT:
                running = false;
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        //        YuvImage image = new YuvImage(rotatedData, ImageFormat.NV21, size.y, size.x,
        // null);
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, MsgConstants.DECODE_SUCCEEDED, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, MsgConstants.DECODE_FAILED);
                message.sendToTarget();
            }
        }
    }
